...
my @hdir_src          = (
                         "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_noisy_maeclose_0.1.wav",
                        );
my $hdir_out          = ("/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_noisy_maeclose_0.1.wav_dnnfa");
