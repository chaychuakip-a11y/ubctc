...
my @hdir_src     = (
                   "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_dnnfa/*-part-*7",
                   );
my $hdir_out     = "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_addnoise_jiaju_0.1.wav_dnnfa";
