...
my @hdir_src     = (
                   "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_dnnfa/*-part-*[4-5]",
                   );
my $hdir_out     = "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_addnoise_gs_0.2.wav_dnnfa";
