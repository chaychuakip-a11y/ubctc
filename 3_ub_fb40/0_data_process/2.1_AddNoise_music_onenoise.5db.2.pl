...
my $jobname0     = "AddNoise_music_onenoise";
my $jobqueue     = "nlp";
my $num_reduce   = 10;
...
my @hdir_src     = (
                   "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_dnnfa/*-part-*[6-7]8",
                   );
my $hdir_out     = "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_addnoise_music_onenoise_0.02.wav_dnnfa";
...
my $noisedata    = "hdfs://mycluster/workdir/asrmlg/dasrmlg/ddye2/noise_huanxing/onenoise_music/onenoise_music.scp.1.pak";#IN
