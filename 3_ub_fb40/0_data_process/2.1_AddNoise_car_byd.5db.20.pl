...
my @hdir_src     = (
                   "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_dnnfa/*-part-*[0-1]",
                   );
my $hdir_out     = "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_addnoise_car_byd_0.2.wav_dnnfa";
...
my $noisedata    = "hdfs://mycluster/workdir/asrdictt/dasrdictt/taoyu/noisedata/chezai/noise_car_byd_rm3-4/iflytek-20231116-part-00000";#IN
