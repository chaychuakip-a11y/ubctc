...
my @hdir_src     = (
                   "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_dnnfa/*-part-*[0-1]8",
                   );
my $hdir_out     = "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_addnoise_music_a_0.02.wav_dnnfa";
...
my $noisedata    = "hdfs://mycluster/workdir/asrdictt/dasrdictt/taoyu/noisedata/16k/2.700h_pure_music_data.pak";#IN
