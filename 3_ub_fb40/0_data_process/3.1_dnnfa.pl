...
my $jobname           = "dnnfa_speedup1.2";#SET
my $jobqueue          = "nlp";#SET
my $num_reduce        = 100;
...
my @hdir_src          = (
                         "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_speedup_0.2.wav",
                        );
my $hdir_out          = ("/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_speedup_0.2.wav_dnnfa");
