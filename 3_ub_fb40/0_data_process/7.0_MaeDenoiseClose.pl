...
my @hdir_src; if (@ARGV > 0) {
    ...
    @hdir_src = (
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_car_byd_0.2.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_car_dz_0.2.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_duodian_0.1.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_gs_0.2.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_jiaju_0.1.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_music_a_0.02.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_music_b_0.02.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_music_c_0.02.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_music_onenoise_0.02.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_music_tv_0.02.wav_dnnfa/*part-*2",
                        "$config_data->{hdfs_out_root}/17kh_wav_addnoise_pingwen_0.1.wav_dnnfa/*part-*2",
                        );
}
my $hdir_out          = "$config_data->{hdfs_out_root}/17kh_wav_noisy_maeclose_0.1.wav";
