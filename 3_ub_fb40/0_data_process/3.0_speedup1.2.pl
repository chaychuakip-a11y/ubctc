...
my @hdir_src     = (
                    "/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_dnnfa/*-part-000[0-1]?",
                   );
my $hdir_out     = ("/workdir/asrdictt/tasrdictt/taoyu/mlg/korean/17kh_wav_speedup_0.2.wav");
...
my $bin_wavspeed       = "$dir_bin/wav_speed_hadoop"; ##/lustre2/asrdictt/yjjiang/jst-data/tools/wav_speed_hadoop/Debug/wav_speed_hadoop
...
::CmdToLocal("$bin_wavspeed -speech -tempo=20%"), #tailin:wav, tailout:out
::CmdToLocal("$bin_selecttail out mlf_sy"),
